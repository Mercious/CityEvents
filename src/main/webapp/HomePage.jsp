...
<main id="main">
    ...
    <div class="search-container">
        <select id="searchRadiusSelect" class="searchRadiusSelect">
            <option>Im Umkreis von 50km</option>
            <option>Im Umkreis von 100km</option>
            <option>Im Umkreis von 150km</option>
            <option>Im Umkreis von 200km</option>
            <option>Im Umkreis von >200km</option>
        </select>
        <input id="searchBar" class="searchBar" placeholder="Nach einem Event oder einer PLZ suchen ..."/>
